            ...
            clockComponent = (
                <React.Fragment>
                    ...
                    <ColorContext.Consumer>
                        {context => <CountdownTypeMmDdYyyy color={context} totalSec={toTalSeconds} pause={_pause}/> }
                    </ColorContext.Consumer>
                    <ControlButtons onClickPauseResume={this.handlePauseResume} onClickRestart={this.handleRestart}/>
                </React.Fragment>   
            );  
        } else if (_showClock === 2) {
            clockComponent = <h3>Please set up timer. Selected date must stay ahead today.</h3>;
        }
        ...
        return (
            <div className="mm-dd-yyyy type-wrapper">
                <form id="formMmDdYyyy" onSubmit={this.handleSubmit}>
                    ...
                    <Button id="start" type="submit" outline color="secondary">Start</Button>
                </form>
